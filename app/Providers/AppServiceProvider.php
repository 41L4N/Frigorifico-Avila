...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        foreach ($listaCompras = ($lC = Cache::get('lista-compras')) ? $lC : [] as $iC => $c) {
            ...
            if (!$p = Producto::find($c['id_producto'])) {
            ...
            $p->precio_unitario = ($p->precio_mayor && $p->cantidad >= $p->pedido_min_mayor) ? $p->precio_mayor : ($precioD = $p->precio_detal) - $p->oferta * $precioD / 100;
